...
?>
<section <?php if(( isset( $atts['custom_id'] ) && $atts['custom_id'] )) echo "id='{$atts['custom_id']}'"?> class="fw-main-row <?php echo esc_attr($section_extra_classes) ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
